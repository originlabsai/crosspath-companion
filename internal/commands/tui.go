...
var TUICmd = &cobra.Command{
	...
	Hidden: true, // Hidden because running `cross_companion` without args launches TUI by default
...
func runTUI(cmd *cobra.Command, args []string) error {
	...
	if cfg.AuthToken == "" {
		fmt.Println("Not authenticated. Please run 'cross_companion login' first.")
		return nil
	}
